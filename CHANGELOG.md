...
### Commits
- 重构首页
- fix(ci): fall back to npm trusted publishing
- docs(changelog): update for v0.2.5
...
### Commits
- chore: bump version to 0.2.4 for npm release
- chore: set base to / and homepage to custom domain
- fix(docs): set VitePress base to /sodialog/ for GitHub Pages
- chore(ci): update GitHub Pages workflow to latest VitePress deployment
- docs(changelog): update for v0.2.3
- docs(changelog): update for v0.2.2-homepage-refactor
...
[Unreleased]: https://github.com/sohophp/sodialog/compare/v0.3.1...HEAD
[0.3.1]: https://github.com/sohophp/sodialog/releases/tag/v0.3.1
[0.3.0]: https://github.com/sohophp/sodialog/releases/tag/v0.3.0
[0.2.6]: https://github.com/sohophp/sodialog/releases/tag/v0.2.6
