  ...
  const componentSidebar = [
    {
      ...
      items: [
        ...
        { text: 'Tooltip', link: withLocale('/components/tooltip', locale) },
        { text: 'Tags Input', link: withLocale('/components/tags-input', locale) },
  ...
  const apiSidebar = [
    {
      ...
      items: [
        ...
        { text: 'Tooltip API', link: withLocale('/api/tooltip', locale) },
        { text: 'Tags Input API', link: withLocale('/api/tags-input', locale) },
  ...
  const examplesSidebar = [
    {
      ...
      items: [
        ...
        { text: 'Tooltip', link: withLocale('/examples/tooltip', locale) },
        { text: 'Tags Input', link: withLocale('/examples/tags-input', locale) },
