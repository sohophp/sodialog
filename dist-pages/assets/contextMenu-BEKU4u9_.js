import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                  */import{b as t,e as a,o as l,i}from"./lib-Bg_MuV9o.js";import{r as s,w as d}from"./lab-shared-C3tuUAEJ.js";const c=document.querySelector("#app");if(!c)throw new Error("Cannot find #app root element");c.innerHTML=`
...
`;d();const n=document.querySelector("#cm-basic-result");t({target:"#cm-basic-zone",items:[{id:"copy",label:"复制"},{id:"rename",label:"重命名"}],onAction:({itemId:e})=>{n&&(n.textContent=`结果输出：执行 action=${e}`),a("success",`已执行 ${e}`,{duration:1100})}});t({target:"#cm-policy-zone",closeOnEsc:!0,closeOnScroll:!0,closeOnWindowBlur:!0,items:[{id:"download",label:"下载 Download"},{id:"rename",label:"重命名 Rename"},{id:"delete",label:"删除 Delete"}],onAction:({itemId:e})=>{a("warning",`已触发动作: ${e}`,{duration:1200})}});document.querySelector("#cm-open-modal")?.addEventListener("click",()=>{l({title:"普通入口 Modal",content:"<p>用于与 ContextMenu 入口对比。</p>"})});let o=null;o=t({target:"#cm-dialog-zone",items:[{id:"open-dialog",label:"打开确认弹窗",onClick:()=>{o&&i(o,{title:"来自 ContextMenu",content:"<p>已执行 close-first-open-next。</p>"})}}]});
